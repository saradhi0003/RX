            ...
            <div style={{ marginLeft:'auto', display:'flex', alignItems:'center', gap:8 }}>
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-52">
                  ...
                  <DropdownMenuItem className="text-red-600" onClick={async () => { try { await UserEntity.logout(); } finally { navigate("/login"); } }}><LogOut className="w-4 h-4 mr-2" />Sign Out</DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
            </div>
          </header>
